...
public class MtomTab extends BaseTab {
	...
	public void initializeTab() {
		...
		tab.addTab(tab.newTabSpec(getString(R.string.mtom_myroom_title)).setIndicator(getString(R.string.mtom_myroom_title)).setContent(new Intent(this, MyRoomActivity.class)));
